...
import { BaseController, HttpMethod, HttpError, ValidateDtoMiddleware, DocumentExistsMiddleware, UploadFileMiddleware, ValidateObjectIdMiddleware } from '../../../rest/libs/index.js';
